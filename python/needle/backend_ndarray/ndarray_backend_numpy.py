...
def ewise_ne(a, b, out):
    out.array[:] = (a.array != b.array).astype(np.float32)


def scalar_ne(a, val, out):
    out.array[:] = (a.array != val).astype(np.float32)
...
def ewise_le(a, b, out):
    out.array[:] = (a.array <= b.array).astype(np.float32)


def scalar_le(a, val, out):
    out.array[:] = (a.array <= val).astype(np.float32)


def ewise_gt(a, b, out):
    out.array[:] = (a.array > b.array).astype(np.float32)


def scalar_gt(a, val, out):
    out.array[:] = (a.array > val).astype(np.float32)


def ewise_lt(a, b, out):
    out.array[:] = (a.array < b.array).astype(np.float32)


def scalar_lt(a, val, out):
    out.array[:] = (a.array < val).astype(np.float32)
